...
export default function Header() {
    ...
    const newGameButton = <button className="btn btn-outline-light" onClick={handleNewGame}>New Game</button>;
    const scoreDisplay = <>
    ...
    return (
        <div className="text-center d-flex flex-column align-items-center gap-3">
            {!isPlay || game.message === GAME_OVER_MESSAGE ? <h1>{game.message || 'SIMON GAME'}</h1> : null}
